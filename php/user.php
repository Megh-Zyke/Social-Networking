...
<div class="home-grid">
    ...
    <div class="posts">
        ...
        $sql = "SELECT * 
                    FROM posts
                    JOIN users ON posts.user_id = $current_user_id and users.user_id = $current_user_id";
            ...
            <div class="post_template">
                ...
                <div class="user_post_info">
                    ...
                    <div class="editButtons">
                        <form action="">
                            ...
                            <button class="editPost" onclick="editPost(<?php echo $row['post_id']; ?>)"> <i
                ...
                <?php if (!empty($row['post_content'])) { ?>
                    ...
                    <div class="post_description">
                        <p class="post_description_text" id="<?php echo 'post' . $row['post_id']; ?>">
